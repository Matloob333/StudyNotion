      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="card py-8 px-4 sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className={`input-primary ${errors.firstName ? 'input-error' : ''}`}
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <select
                  ...
                  className={`input-primary ${errors.accountType ? 'input-error' : ''}`}
                >
              ...
              {errors.accountType && (
                <p className="mt-2 text-sm text-error-600 dark:text-error-400">{errors.accountType.message}</p>
              )}
            </div>
            ...
            {errors.terms && (
              <p className="text-sm text-error-600 dark:text-error-400">{errors.terms.message}</p>
            )}
